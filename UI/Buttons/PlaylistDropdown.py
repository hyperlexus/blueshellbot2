...
class PlaylistDropdown(Select, AbstractItem):
    ...
    def __init__(self, bot: BlueshellBot, handler: type[AbstractHandler], playlist: Playlist, textChannel: TextChannel,
                 guildID: int, category: MessagesCategory):
        ...
        super().__init__(placeholder="(not fully functional) Select different song to play",
