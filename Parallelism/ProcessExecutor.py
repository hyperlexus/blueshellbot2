...
class ProcessCommandsExecutor:
    ...
    def __init__(self, bot: BlueshellBot, guildID: int) -> None:
        self.__bot = bot
    ...
    @classmethod
    async def sendNowPlayingToGuild(cls, bot: BlueshellBot, playlist: Playlist, channel: TextChannel, song: Song, guild: Guild) -> None:
    ...
    @classmethod
    def __getPlayerViewForGuild(cls, channel: TextChannel, guildID: int, bot: BlueshellBot) -> View:
    ...
    def __getPlayerButtonsForGuild(cls, textChannel: TextChannel, guildID: int, bot: BlueshellBot) -> List[Button]:
        ...
        buttons: List[Button] = [HandlerButton(bot, PrevHandler, cls.EMOJIS.BACK,
                                 ...
                                 HandlerButton(bot, ResumeHandler, cls.EMOJIS.PLAY,
                                               textChannel, guildID, MessagesCategory.PLAYER, "Play"),
                                 HandlerButton(bot, StopHandler, cls.EMOJIS.STOP,
